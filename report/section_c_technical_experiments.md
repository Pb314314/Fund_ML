...
![Fig. 1: Tokenization fertility and attention-cost multiplier across six languages.](../figures/fig1_tokenization_fertility.png)
...
![Fig. 2: KV-cache capacity and maximum sequence length across five hardware tiers for Llama-3-8B 4-bit AWQ.](../figures/fig2a_kv_cache_growth.png)
...
![Fig. 3: End-to-end latency comparison for a 100-word semantic task across languages and hardware tiers.](../figures/fig3a_latency_comparison.png)
